    ...
    <div className="flex justify-center items-center min-h-screen bg-white">
      <div className="bg-white text-gray-900 p-8 rounded-2xl shadow-lg border border-gray-200 w-full max-w-3xl">
        ...
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-3xl font-extrabold text-gray-800">Your Bookings</h2>
          ...
          <div className="max-h-80 overflow-y-auto space-y-6 border border-gray-200 rounded-lg p-4">
            <ul className="space-y-6">
              {filteredBookings.map((booking) => (
                <li key={booking._id} className="p-6 bg-gray-50 rounded-xl shadow-md border border-gray-200">
                  <div className="space-y-2">
                    <p>
                      <span className="font-semibold text-gray-700">Service:</span> {booking.service?.name || "N/A"}
                    </p>
                    <p>
                      <span className="font-semibold text-gray-700">Price:</span> ₹{booking.service?.price || "N/A"}
                    </p>
                    <p>
                      <span className="font-semibold text-gray-700">Payment Status:</span> {booking.paymentStatus || "N/A"}
                    </p>
                    <p>
                    ...
                    <p>
                      <span className="font-semibold text-gray-700">Time:</span> {booking.bookingTime}
                    </p>
                  ...
                  {booking.status !== "Completed" && booking.status !== "Cancelled" && (
                    <button
                      ...
                      className="mt-4 w-full px-5 py-2 bg-red-500 text-white font-semibold rounded-lg hover:bg-red-400 transition-all shadow-md"
                    >
                      Cancel Booking
                    </button>
                  )}
