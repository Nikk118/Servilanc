...
function Cleaning() {
  ...
  useEffect(() => {
    const fetchServices = async () => {
      try {
        const res = await axiosInstant.get("http://localhost:3000/api/cleaning/allCleaningService");
  ...
  return (
    <div className="py-12 px-6 bg-gradient-to-b from-gray-900 to-gray-800 min-h-screen">
      <h1 className="text-4xl text-center text-white font-extrabold mb-12">🧹 Cleaning Services</h1>
