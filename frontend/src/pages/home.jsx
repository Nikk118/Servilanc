...
export default function Home() {
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen">
      ...
      {/* Hero Section */}
      <header className="relative bg-cover bg-center h-[50vh] flex flex-col justify-center items-center">
      ...
      <section className="p-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="relative rounded-xl overflow-hidden shadow-xl hover:shadow-2xl transition">
          <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center p-6">
            ...
            <p className="text-gray-300 mt-2 text-center">
              Get expert plumbers for all your needs.
            </p>
            <button
              onClick={() => navigate("/plumbing")}
              className="mt-4 px-5 py-3 bg-blue-500 text-lg rounded-xl hover:bg-blue-600 transition"
            >
              Book Now
            </button>
          </div>
          <img
            src="https://res.cloudinary.com/backend-node/image/upload/f_auto/v1741579342/f6fyoglw0eiauqadvvfz.avif"
            alt="Plumbing"
        ...
        <div className="relative rounded-xl overflow-hidden shadow-xl hover:shadow-2xl transition">
          <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center p-6">
            ...
            <p className="text-gray-300 mt-2 text-center">
              Top-rated cleaners for your home and office.
            </p>
            <button
          ...
          <img src="" alt="Cleaning" className="w-full h-64 object-cover" />
        </div>
        ...
        <div className="relative rounded-xl overflow-hidden shadow-xl hover:shadow-2xl transition">
          <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center p-6">
            ...
            <p className="text-gray-300 mt-2 text-center">
              Beauty & grooming services at your doorstep.
            </p>
            <button
          ...
          <img src="" alt="Salon" className="w-full h-64 object-cover" />
        </div>
      </section>
      ...
      <section className="p-10">
        ...
        <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            ...
            "The cleaning professionals did an amazing job. Highly recommended!",
          ].map((feedback, index) => (
      ...
      <footer className="bg-gray-800 p-8 text-center text-gray-400 mt-10">
        <p>
          &copy; {new Date().getFullYear()} Servielliance. All rights reserved.
        </p>
