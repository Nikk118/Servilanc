        ...
        <ul className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {services && services.length > 0 ? (
            services.map((service) => (
              <li key={service._id} className="flex flex-col sm:flex-row items-center bg-gray-800 p-4 rounded-lg">
                {/* Image Section (Left) */}
                <img src={service.image_url || "/default-pest-control.jpg"} alt={service.name} className="w-20 h-20 rounded-lg object-cover mb-2 sm:mb-0 sm:mr-4" />
