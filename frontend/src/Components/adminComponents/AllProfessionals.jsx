              ...
              <div className="mt-4 p-4 bg-gray-700 rounded-lg">
                ...
                <div className="mt-2">
                  <p className="text-white">
                    <strong>Service:</strong> {pro.acceptedBookingDetails[0].service.name}
                  </p>
                  <p className="text-white">
                    <strong>Description:</strong> {pro.acceptedBookingDetails[0].service.description}
                  </p>
                  <p className="text-white">
                    <strong>Scheduled Date:</strong>{" "}
                    {new Date(pro.acceptedBookingDetails[0].booking.bookingDate).toDateString()}
                  </p>
                  <p className="text-white">
                    <strong>Time:</strong> {pro.acceptedBookingDetails[0].booking.bookingTime}
                  </p>
                  <p className="text-white">
