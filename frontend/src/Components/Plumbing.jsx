    ...
    <div className="p-6">
      <button
        onClick={() => {
          setIsModalOpen(true);
          setIsUpdateMode(false);
          setFormData({ name: "", description: "", price: "", duration: "", image_url: null, category: "Plumber" });
        }}
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-gray-800 p-6 rounded-lg w-96 relative">
            ...
            <h3 className="text-xl font-semibold mb-4">{isUpdateMode ? "Update Plumbing Service" : "Add New Plumbing Service"}</h3>
