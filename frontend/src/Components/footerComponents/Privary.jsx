      ...
      <div className="max-w-4xl mx-auto text-center px-6">
        ...
        <div className="bg-white shadow-lg rounded-lg p-8 text-left">
          ...
          <p className="text-gray-600 leading-relaxed">
            At Servilanc, we value your privacy. This policy outlines how we collect, use, and protect your personal information.
          </p>
          ...
          <p className="text-gray-600 leading-relaxed">
            ...
            <span className="text-blue-600 font-semibold"> privacy@servilanc.com</span>.
          </p>
        </div>
      </div>
    </section>
