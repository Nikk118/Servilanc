...
import {addBooking, getBooking,cancelBookingByUser,accpetBooking, completeBooking} from "../controller/booking.controller.js"
const router=Router()
...
router.route("/cancleBooking/:bookingId").patch(verifyJWT,cancelBookingByUser)
